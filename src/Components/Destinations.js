...
function Destinations({ items, setItems, onHomeClick, onBackClick, onNextClick, addVacationDestination }) {
          ...
          <ul className="list-unstyled border p-3">
            <div className="inputContainer mb-3">
              <input
                ...
                placeholder='Add Your Own Destination'
              />
              <button onClick={() => addVacationDestinationClick(newItemName)} className="btn">+</button>
            </div>
